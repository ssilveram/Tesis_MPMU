...
Este directorio (`/Data/3_Results/`) almacena los resultados del proyecto, estructurados según el flujo de trabajo en R:
...
3. Descomprima/copie los archivos descargados dentro de las carpetas correspondientes (`3_Results`) en su copia local de este repositorio.
